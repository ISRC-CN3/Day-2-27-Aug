% r2vm.m
% Reduced 2-variable model from Wong and Wang (2006) with no recurrent AMPA
% To be used in conjunction with r2vm.ode
...
for ww = 1:N_trials % Trial loop
    ...
    for t = 1:T_total
        ...
        I_stim_1 = (500/dt<t & t<(Tstim+500)/dt)*(JAext*mu0*(1+coh/100)); % To population 1
        I_stim_2 = (500/dt<t & t<(Tstim+500)/dt)*(JAext*mu0*(1-coh/100)); % To population 2
